...
struct ResultView: View {
  ...
  var body: some View {
    ScrollView {
      VStack {
        Text("Hi, \(username) kamu seperti...").font(.largeTitle).fontWeight(.bold).padding(.horizontal, 16).padding(.bottom, -12).zIndex(100)
        ...
        VStack {
          ...
          if players.count > 0 || (players.count == 1 && players[0].username == username) {
